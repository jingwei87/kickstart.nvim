...
if vim.g.vscode then
  ...
  -- To conditionally activate plugins, the best solution is to use the LazyVim VSCode extra.
  -- However, packer.nvim and lazy.nvim have built-in support for cond = vim.g.vscode and vim-plug has a few solutions.
